...
debugger_agent_node,misc_node,summarize_node)
...
graph.add_conditional_edges('executor',lambda state: "summarize" if "success" in state['messages'][-1].content.lower() else "debugger")
